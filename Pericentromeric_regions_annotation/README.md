...
Indeed, using this strategy, I have been able to select alignments with the best scores for each sub-sequences and on most of the chromosomes. We can clearly see that closer alignments are to centromeres, higher their scores are ([Figure 5](https://htmlpreview.github.io/?https://github.com/YoannPa/Computational_Epigenomics/blob/master/Pericentromeric_regions_annotation/figures/Fig5.html)).   
Furthermore, sub-sequences alignments selected were not ubiquitous of all chromosomes ([Figure 6](https://htmlpreview.github.io/?https://github.com/YoannPa/Computational_Epigenomics/blob/master/Pericentromeric_regions_annotation/figures/Fig6.html)). For example:  
...
Alignement frames ratio on the genome is also pretty balanced: almost 50% in forward, and 50% in reverse ([Figure 7](https://htmlpreview.github.io/?https://github.com/YoannPa/Computational_Epigenomics/blob/master/Pericentromeric_regions_annotation/figures/Fig7.html)).  
...
Based on all the selected PICS and satellites (see [Figure 10](https://htmlpreview.github.io/?https://github.com/YoannPa/Computational_Epigenomics/blob/master/Pericentromeric_regions_annotation/figures/Fig10.html)) I defined pericentromeric regions as following for each chromosome:  
...
The pericentromeric regions defined this way are sumarized on [Figure 11](https://htmlpreview.github.io/?https://github.com/YoannPa/Computational_Epigenomics/blob/master/Pericentromeric_regions_annotation/figures/Fig11.html).  
